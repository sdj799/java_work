...
/*
 ...
 2. 메서드 호출불에서 어떤 매개값을 전달하는냐에 따라
 매서드의 실행 결과는 달라질 수 있습니다.
 
 3. 매개값을 몇 개 받아서 사용할 지는 메서드를 선언할 때 선언부에서
 ()안에 미리 개수와 타입을 지정합니다. 최대 255개까지(4개 넘어가면 힘들어짐)
...
public class MethodExample2 {
	...
	static int calcNumberTotal2(int... nums) { //값을 배열로 묶어서 전달
		int total = 0;
		for(int i : nums) {
			total += i;
		}
