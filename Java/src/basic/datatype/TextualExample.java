...
public class TextualExample {
	...
	public static void main(String[] args) {
		...
		char c1 = 'A';
		System.out.println(c1); //단일 문자만 가능, ''만 가능
		
		char c2 = 44032;
		System.out.println(c2); //아스키코드 기반으로 저장, 유니코드 한글, 음수는 없음
		
		/*
		 # 문자열 저장할 수 있는 데이터 타입 String
		 - 저장하고 싶은 문자열을 겹따옴표("")에 담아 대입합니다.
		 - String은 기본 데이터 타입은 아니지만 자주 쓰이기 때문에
		 기본 데이터 타입처럼 사용합니다. (사실은 객체 타입) class
		*/
		...
		System.out.println(s1 + s2); //덧셈 이외에는 지원하지 않음
