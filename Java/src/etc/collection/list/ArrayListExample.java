...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		List<String> nick = new ArrayList<>();//다형성을 위해 list타입으로 생성
...
//		String name = nick[3]; (x) 배열의 방법
		...
		//contains(객체): 리스트 내의 객체의 유무를 파악하는 메서드.
		...
		List<Integer> score = new ArrayList<>(); //객체타입만 가능 int(x)
		score.add(65);
